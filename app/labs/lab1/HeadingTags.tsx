  ...
  return (
    <div>
      ...
      <div id="wd-ai-headings">
        <h4>Lab notes</h4>
        This outline shows how smaller heading tags nest under one another to
        break a page into sections and subsections.
        <h5>What I built</h5>A short sample page that demonstrates the heading
        tags alongside a few other basic HTML elements.
        <h6>Next step</h6>
        Add more examples to this page as the lab introduces new tags.
      </div>
    </div>
  );
}
