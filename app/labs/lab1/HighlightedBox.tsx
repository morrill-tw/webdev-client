    ...
    <div id="wd-highlighted-box">
      ...
      >
        <p>
          <h4>Tyler</h4>
          <ul>
            <li>Get better with React.</li>
            <li>Learn how to build a web application from start to finish.</li>
            <li>
              Understand how different web technologies interact with each
              other.
            </li>
          </ul>
        </p>
